...
export const FlashSale = ({ data }) => {
    ...
    if (!data) {
        ...
        const filteredData = data.filter(item => item.discount > 0.2);
        const maxOffset = -(distance * (filteredData.length - 5));
            ...
            <div className="my-[45px]">
                ...
                <div className='bg-blue-950 rounded-lg px-[12px] py-[18px] relative'>
                    ...
                    <div className="direction w-full flex justify-between absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                        ...
                        <button onClick={() => handleNext(maxOffset)} className='w-[40px] aspect-square rounded-full bg-gray-200 text-gray-600'>
